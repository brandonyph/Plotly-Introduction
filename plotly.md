...
Section 1 - Plotly Syntax \* Understanding the Plotly syntax/structure
\* The data table, defining x-axis, y-axis and z-axis \* Adding line
onto Plotly chart \* Adding Multiple line with different color \* Adding
path and other Add\_\* to Plotly

Section 2 -Plotly Layout \* Basics of x and y axis \* Defining
customizing lines and grid \* Ranges of x and y axis \* Plotting
categorical data \* Box plot \* Adding Shapes and Annotation \* Merging
Axis from multiple plot

Section 3 - Final Output \* Plotting a 3D plot, with custom axis, \*
